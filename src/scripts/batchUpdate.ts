...
//         console.error(
//             "Invalid level. Level must be an integer between 0 and 5, or -1 to fetch exceptional addresses."
//         );
//         process.exit(1);
//     }
...
//             multicallHelper.batchGetV2EdgeBlockTimestamp.bind(multicallHelper);
//         updateTimestampFunction =
//             sqliteHelper.batchUpdateV2EdgeBlockTimestamp.bind(sqliteHelper);
//     } else if (edgeType === "v3") {
//         if (level === -1) {
...
//         }
//         getTimestampFunction =
//             multicallHelper.batchGetV3EdgeBlockTimestamp.bind(multicallHelper);
//         updateTimestampFunction =
//             sqliteHelper.batchUpdateV3EdgeBlockTimestamp.bind(sqliteHelper);
//     } else {
